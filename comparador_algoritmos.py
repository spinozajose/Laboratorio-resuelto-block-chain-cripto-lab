...
def mostrar_observaciones():
    ...
    print("│    Respuesta: La razon es que AES trabaja con bloques de 128 bits                      │")
    print("│ (16 bytes), mientras que DES trabaja con bloques de 64 bits (8 bytes)                  │")
    print("│                                                                                        │")
    print("│  2. ¿Qué relación hay entre el tamaño de bloque y el padding?                          │")
    print("│     Respuesta: el padding intenta rellenar el resto de bytes que le                    │")
    print("│hace falta al bloque, el cifrador se encarga de rellenar estos huecos                   │")
    print("│y el descifrador ya sabe que huecos son relleno, ya que valores especificos lo indican. │")
    print("│                                                                                        │")
    print("│  3. ¿Por qué DES se considera inseguro hoy en día?                                     │")
    print("│     Respuesta: Como es un diseño antiguo es muy vulnerable al                          │")
    print("│     poder de computo actual, con bloques pequeños y                                    │")
    print("│     faciles de aplicar fuerza bruta                                                    │")
    print("│                                                                                        │")
    print("│  4. ¿Cuál algoritmo elegirías para una blockchain y por qué?                           │")
    print("│     Respuesta: Elijiria AES-256 ya que es el standard actual y el computo actual no es │")
    print("│   capaz de violar la integridad de los datos, si hay transacciones de datos sensibles  │")
    print("│   como lo hay en la blockchain se cifraría la infrormacion con AES antes de cualquier  │")
    print("│   intercambio.                                                                         │")
    print("└────────────────────────────────────────────────────────────────────────────────────────┘")
